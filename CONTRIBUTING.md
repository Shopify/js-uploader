...
our [Code of Conduct](https://github.com/Shopify/js-uploader/blob/master/CODE_OF_CONDUCT.md).
...
```
git clone git@github.com:your-username/js-uploader.git
```
...
## Examples
See [here](https://github.com/Shopify/js-uploader/blob/master/examples) for our examples.
